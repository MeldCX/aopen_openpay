 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
namespace Aopen\Openpay\Model\Zend\Rest;
...
class Client extends \Zend_Service_Abstract
{
    ...
    private function _prepareRest($path)
    {
        ...
        /* Need to set headers and configuration */
        self::getHttpClient()->setHeaders($this->_getHeaders());
        self::getHttpClient()->setConfig($this->_getConfig());    }
